package su.appoint.jm_education_project.reflection;

import org.springframework.stereotype.Component;
import org.springframework.util.ReflectionUtils;
import su.appoint.jm_education_project.annotation.Ordered;
import su.appoint.jm_education_project.exception.NotSelectField;
...
public class FilterQueryReflection<T> {
    ...
    public String getFilteredQuery(String filteringPattern, String alias, Class<T> persistentClass) {
        ...
        ReflectionUtils.doWithFields(persistentClass, field -> {
            ...
            Class<?> rootClass = field.getAnnotation(su.appoint.jm_education_project.annotation.Field.class).targetEntity();
        ...
        }, field -> field.isAnnotationPresent(su.appoint.jm_education_project.annotation.Field.class));
    ...
    private void searchFieldInBody(Class<?> source, String root, StringBuilder query, String alias) {
        ...
        ReflectionUtils.doWithFields(source, field -> {
            ...
            if (field.getAnnotation(su.appoint.jm_education_project.annotation.Field.class).targetEntity() != void.class) {
                searchFieldInBody(field.getAnnotation(su.appoint.jm_education_project.annotation.Field.class).targetEntity(), field.getName(), query, alias);
            } else {
